...
type TooltipContentProps = React.ComponentProps<'div'> & {
  ...
  labelKey?: string
  label?: React.ReactNode
  labelFormatter?: (value: React.ReactNode, payload: ReadonlyArray<Record<string, unknown>>) => React.ReactNode
          ...
          >
            {itemConfig?.icon && !hideIcon ? (
              ...
              <div
                ...
                style={{ backgroundColor: typeof item.color === 'string' ? item.color : undefined }}
              />
            )}
            {itemConfig?.label}
          </div>
